...
import id.co.edtslib.edtsuikit.databinding.ItemPromotionCouponLoadingBinding
...
class CouponLoadingCardView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = com.google.android.material.R.attr.materialCardViewStyle
) : MaterialCardView(context, attrs, defStyleAttr) {

    val binding = ItemPromotionCouponLoadingBinding.inflate(context.inflater, this, true)

    private var notchRadiusPx: Float = 8.dp
    private var notchRoundedPx: Float = 0f
    private var updateOnLayout: Boolean = true

    private val dividerId = binding.divider.id
